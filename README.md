...
| 0422 ~ 0426   |  문제점    |
|:------------------|------------------:|
|[0422 :<br>- wave증가할 때 지뢰 증가 <br>- wave 5까지 추가할 지뢰 만들기 <br>- wave5되면 게임오버 띄우기  <br>- (4-3강)캠포지션 변경<br>- 케릭터UI왼쪽 화면 4강](storageFiles/schedule/0422.md) |[0422 : 캠 추적](storageFiles/trouble/0422T.md) |
