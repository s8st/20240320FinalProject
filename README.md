...
|0423 :  <br>- 케릭터 선택 창 꾸미기<br>- 조이스틱 webgl에서 작동하게 수정하기<br>|[0423 : <br>webgl로 빌드하면 한글은 오류<br>조이스틱 문제<br>](storageFiles/trouble/0423T.md)|
|**`0424 : 개발 마감`**<br>- 최종 빌드하기<br>- 브로셔 작성 |------------------|
|0425 :- 브로셔 작성<br><br>  ||
